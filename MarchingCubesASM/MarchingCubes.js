...
MarchingCubes = class {
    ...
    _executeNextJob() {
        ...
        if (nThreads <= 1 || meta.dimensions.z < nThreads) {
            let worker = new Worker("./MarchingCubesAsmWorker.js");
            ...
            // Pass meta data
            worker.postMessage({dimensions: meta.dimensions, voxelDimensions: meta.voxelDimensions, zFull: meta.dimensions.z, isoLevel: meta.isoLevel});
        ...
        // MULTIPLE WORKERS EXECUTION
            ...
            for (let i = 0; i < nThreads; i++) {
                ...
                worker.postMessage({dimensions: {x: meta.dimensions.x, y: meta.dimensions.y, z: paddedSize, zFull: meta.dimensions.z, offset: zAxisOffset},
                    voxelDimensions: meta.voxelDimensions, isoLevel: meta.isoLevel});
                // Pass data
